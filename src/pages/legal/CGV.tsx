...
import { getCGV } from "@/lib/legal-loader";

const cgvData = getCGV();
...
const CGV = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>{cgvData.title} - Arkadhya Centre Ayurvédique</title>
        <meta name="description" content={cgvData.metaDescription} />
        <link rel="canonical" href={cgvData.canonicalUrl} />
      </Helmet>
