...
import { Calendar, Clock, ArrowLeft, ChevronUp, Phone, AlertTriangle, CheckCircle2 } from 'lucide-react';
...
const Osteoporose = () => {
  ...
  const tableOfContents = [
    { id: 'intro', label: "L'Ostéoporose" },
    { id: 'approches', label: 'Deux Approches' },
    { id: 'dhatus', label: 'Les 7 Dhatus' },
    { id: 'test', label: '🧪 Test Profil Osseux' },
    { id: 'profils', label: 'Les 3 Profils' },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                <strong>29 millions de personnes touchées en Europe.</strong> L'Ayurvéda révèle une vérité bouleversante : vos os ne sont pas juste du « béton biologique ». 
                Ils sont le siège de votre force vitale (Ojas), le reflet de votre feu digestif (Agni).
              </p>

              <div className="flex gap-4">
                <Button onClick={() => scrollToSection("test")}>
                  🧪 Test Profil Osseux
                </Button>
                <Button variant="outline" onClick={() => scrollToSection("intro")}>
                  📖 En savoir plus
                </Button>
              </div>
            </div>
        ...
        <div className="container px-4">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <article className="flex-1 max-w-4xl">
              ...
              {/* Deux Approches */}
              <section id="approches" className="mb-16">
                <h2 className="text-3xl font-serif font-semibold mb-8 text-foreground">
              ...
              {/* Les 7 Dhatus */}
              <section id="dhatus" className="mb-16">
                <h2 className="text-3xl font-serif font-semibold mb-8 text-foreground">
              ...
              {/* Protocole d'Urgence */}
              <section id="urgence" className="mb-16">
                <h2 className="text-3xl font-serif font-semibold mb-8 text-foreground">
              ...
              <section className="mb-16">
                <Card className="bg-gradient-to-br from-primary/20 to-secondary/20 border-primary/30">
                  <CardContent className="p-8 text-center">
                    ...
                    <div className="grid grid-cols-5 gap-4 mb-8 text-left max-w-3xl mx-auto">
                      {[
                        ...
                        <div key={i} className="text-center">
                          ...
                          <div className="font-semibold text-foreground text-sm">{pillar.title}</div>
                          <div className="text-xs text-muted-foreground hidden md:block">{pillar.desc}</div>
                        </div>
                      ))}
                    </div>
