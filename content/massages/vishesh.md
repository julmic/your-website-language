...
image: "/src/assets/massages/vishesh-new.png"
...
forWhom:
  physical:
    ...
    - "Vertiges"
  mental:
    - "Stress accumulé dans le corps"
    - "Besoin de libération des tensions"
  wellness:
    - "Sportifs"
    - "Personnes travaillant en position assise prolongée"
contraindications:
  - "Inflammation aiguë"
  - "Fractures récentes"
  - "Problèmes de peau"
...
benefits:
  physical:
    - "Soulagement profond des tensions"
    - "Amélioration de la mobilité"
    - "Réduction des douleurs"
    - "Meilleure circulation"
  mental:
    - "Libération du stress corporel"
    - "Sensation de légèreté"
    - "Meilleur sommeil"
  energetic:
    - "Déblocage des canaux énergétiques"
...
relatedMassages:
  - name: "Abhyanga"
    path: "/services/abhyanga"
    description: "Massage traditionnel aux huiles"
  - name: "Marma-Thérapie"
    path: "/services/marma-therapie"
    description: "Stimulation des points vitaux"
---
